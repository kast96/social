...
type ActionTypes = FollowSuccessActionType | UnollowSuccessActionType | SetUsersActionType | SetCurrentPageActionType |
...
export const getUsers = (currnetPage: number, pageSize: number): ThunkType => {
